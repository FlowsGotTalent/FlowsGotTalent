      ...
      <div class="bg-white text-gray-600 text-center mx-auto">
        ...
        <main class="container mx-auto">
          ...
          <div v-else>
            ...
            <button @click="resetRound" class="bg-pink-500 text-white rounded text-lg py-2 px-4 hover:bg-pink-400">Play
              another round
            </button>
            ...
            <button @click="resetValues"
                    class="bg-pink-500 text-white rounded text-lg mt-6 py-2 px-4 hover:bg-pink-400">
              Reset game
            </button>
