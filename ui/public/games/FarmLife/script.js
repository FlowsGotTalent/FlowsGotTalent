...
var countSheep = setInterval(function () {
    ...
    //update trapped
    const trapped = document.querySelectorAll(".catched").length;
    ...
    if (trapped >= 10) {
        parent.postMessage({name: "gameEvent", score: 11 - lostSheep, nextRound: 7}, "*")
    }
    ...
    if (
        ...
        switch (lostSheep) {
            ...
            case 2:
                ...
                break;
            case 3:
                finalText = "OPS!<br><br> " + lostSheep + " SHEEP LOST, NO BUENO";
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            case 6:
                finalText = "NOOOOO!<br><br> YOU LOST HALF THE FLOCK";
                break;
            case 7:
